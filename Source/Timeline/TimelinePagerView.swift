...
public class TimelinePagerView: UIView {
    ...
    public func updateStyle(_ newStyle: TimelineStyle) {
        ...
        timelinePager.reusableViews.forEach{ timelineContainer in
            timelineContainer.delegate = self
    ...
    func configureTimelinePager() {
        ...
        for i in -1...1 {
            ...
            emptyContainer.frame = timeline.frame
            
            let verticalScrollView = TimelineContainer(timeline,emptyContainerView : emptyContainer)
            verticalScrollView.addSubview(emptyContainer)
            verticalScrollView.addSubview(timeline)
            verticalScrollView.reloadEmptyView()
    ...
    public func reloadData() {
        ...
        timelinePager.reusableViews.forEach{ $0.reloadEmptyView() }
    }
